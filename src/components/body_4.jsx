...
export const amazing_works = [
  {
    ...
    title: "Quiz App",
    description:
      "This page is a landing page of the official site of sunnySide company",
...
const Body_4 = () => {
  ...
  return (
    ...
    >
      ...
      <img
        src={arrow_img}
        className="hidden sm:block rotate-180 absolute left-[25%] z-0"
        alt=""
      />
      <div className="flex flex-wrap gap-5 justify-center mb-28  ">
        {amazing_works.map((elt, index, array) => {
          return (
            <div
              key={index}
              className="flex flex-col p-5 shadow-2xl hover:bg-black hover:bg-opacity-30 w-[80vw] sm:w-[20vw] sm:h-96 relative rounded-lg "
            >
